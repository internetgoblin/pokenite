...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const RUINS_OF_ALPH_OUTSIDE,                       10, 19 ; 22
	...
	map_const CHERRYGROVE_CITY,                            20, 15 ;  3
