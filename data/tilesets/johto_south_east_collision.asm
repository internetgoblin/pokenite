	...
	tilecoll HOP_DOWN, FLOOR, WALL, FLOOR ; 25
	tilecoll FLOOR, FLOOR, WALL, FLOOR ; 26
	tilecoll WALL, WALL, WALL, WALL ; 27
	tilecoll FLOOR, HEADBUTT_TREE, FLOOR, FLOOR ; 28
	tilecoll WALL, WALL, FLOOR, HEADBUTT_TREE ; 29
	...
	tilecoll HOP_DOWN, FLOOR, WALL, FLOOR ; 97
	tilecoll HOP_RIGHT, WALL, HOP_RIGHT, WALL ; 98
	tilecoll HOP_DOWN, FLOOR, WALL, FLOOR ; 99
	tilecoll HOP_DOWN, HOP_DOWN, WALL, WALL ; 9a
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; 9b
	tilecoll WALL, FLOOR, FLOOR, FLOOR ; 9c
	tilecoll FLOOR, FLOOR, WALL, WARP_CARPET_DOWN ; 9d
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, WALL ; 9e
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE ; 9f
	tilecoll WALL, WALL, WALL, WALL ; a0
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE ; a1
