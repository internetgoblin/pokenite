...
; New to Crystal
	...
	const EVENT_KOTORA_JOINS_BLANKA
	...
	const EVENT_GOLDENROD_CAFE_GOSSIP1
	...
	const EVENT_BERRY_ROUTE_29
	const EVENT_BERRY_ROUTE_30
	const EVENT_B_ROUTE_30
	const EVENT_RIVAL_MEETING
	const_skip
