	...
	tilepal 0, RED, GREEN, GREEN, GREEN, GREEN, GREEN, ROOF, ROOF
	tilepal 0, ROOF, ROOF, ROOF, ROOF, ROOF, ROOF, RED, GREEN
	tilepal 0, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN, ROOF, GREEN
	tilepal 1, GRAY, GRAY, BROWN, RED, RED, GRAY, YELLOW, BROWN
	tilepal 1, RED, RED, BROWN, BROWN, BROWN, BROWN, GRAY, RED
	tilepal 1, GRAY, BROWN, BROWN, GRAY, BROWN, GRAY, GRAY, YELLOW
	tilepal 1, YELLOW, BROWN, BROWN, BROWN
