...
Route46LassScript:
	faceplayer
	opentext
	writetext Route46LassProblemText
	waitbutton
	closetext
	end
...
Route46LassProblemText:
	text "I'm feeling awfully"
	line "sleepy, for some"
	cont "reason."
	done
...
Route46_MapEvents:
	...
	object_event 10, 29, SPRITE_LASS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route46LassScript, -1
