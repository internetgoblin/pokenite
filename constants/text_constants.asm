...
; nameplates
DEF NAMEPLATE_WIDTH  EQU SCREEN_WIDTH
DEF NAMEPLATE_INNERW EQU NAMEPLATE_WIDTH - BORDER_WIDTH
DEF NAMEPLATE_HEIGHT EQU 3
DEF NAMEPLATE_INNERH EQU NAMEPLATE_HEIGHT - BORDER_WIDTH
DEF NAMEPLATE_X      EQU TEXTBOX_X
DEF NAMEPLATE_INNERX EQU 3
DEF NAMEPLATE_Y      EQU 0
DEF NAMEPLATE_INNERY EQU NAMEPLATE_Y + 1
DEF NAMEPLATE_FLAG   EQU 0
